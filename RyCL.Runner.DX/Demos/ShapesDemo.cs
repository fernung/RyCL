...
{
    public class ShapesDemo : ClientCL
    {
        ...
        {
            if (_keys[Keys.D1])      { _graphics.Fill(0); _shape = DrawLines; }
            else if (_keys[Keys.D2]) { _graphics.Fill(0); _shape = DrawTriangles; }
            else if (_keys[Keys.D3]) { _graphics.Fill(0); _shape = FillTriangles; }
            else if (_keys[Keys.D4]) { _graphics.Fill(0); _shape = DrawRectangles; }
            else if (_keys[Keys.D5]) { _graphics.Fill(0); _shape = FillRectangles; }
            else if (_keys[Keys.D6]) { _graphics.Fill(0); _shape = DrawCircles; }
            else if (_keys[Keys.D7]) { _graphics.Fill(0); _shape = FillCircles; }
            else if (_keys[Keys.D8]) { _graphics.Fill(0); _shape = DrawRandom; }
        ...
        private void DrawCircles()
        {
            ...
            var radius = _random.Next(0, Width >> 1);
            var color = _random.Next() | (0xFF << 24);
            _graphics.DrawCircle(x, y, radius, color);
        }
        private void FillCircles()
        {
            ...
            var radius = _random.Next(0, Width >> 1);
            var color = _random.Next() | (0xFF << 24);
            _graphics.FillCircle(x, y, radius, color);
        }
